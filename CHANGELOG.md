...
- Options floating window now appears in the center of the Ping window

## [0.3.1] - 2026-08-12

### Added

- Sidebar with cards that open their respective chat when pressed

### Changed

- Main window size is now saved in options
- Options now save upon quiting Ping
- Ping now starts on a blank screen
- Sidebar width (split offset) is now saved in options
- Updated language Gakotolo

## [0.3.0] - 2026-08-11

### Added

- File picker now appears upon pressing the attach button (does nothing when file is selected for now)
- Partially implemented message caching and data binding for that caching
- Replying to messages
- User IDs, a user identifier independent of usernames

### Changed

- Options now save upon exiting the options screen
- Switched from TCP to Websocket for communication with the server

### Removed

- Ok button on connection issues dialog
